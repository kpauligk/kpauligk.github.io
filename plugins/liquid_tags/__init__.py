...
<meta content="aRGjn+HBH0EyIQ8fVKh4bZl2+Oq4na6vgnzSzApwubzsQP/Ui4cSOfJ0RUil8qE1mQmAePHsVvGGcuVBGt/29A==" name="csrf-token" />
...
<ul id="user-links">
  ...
  <li>
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="IKSiILCMOPRfpXY82l7X8hnd7VfYdRSkzJZy0R9z41l2rXPWZXP2vs6sSWEDOqMpjcGVPY5YwsQQclns7i2J8g==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="HFTroxrcd2VXzZQNt+BFaZgB3eWpC5uEHUC+aIZ1XKk+bW5QI9lndw42TVMxbwix8K0BBNo6j9jbzDRjxomoKQ==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="6547965" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="nDc03mEDJ3qdlcwBN0U6rJ2NKsuwfF9QuI1cq8wmxvPieSlJN6g4tUzkyNItWkU+/7JH8jsT+jslCZ7ybOkPBQ==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="9b+fxOc8WRpHlD9XMT9VRUfi1Y9ThySwJHLudEheARq4C/tn4xwPsUOYhry0lGQd/fqXjrGLicGx7BoXNlzxjA==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/getpelican/pelican-plugins/blob/0fd006cec96a2aecc8c66119c67a9f704127e1c0/liquid_tags/__init__.py" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:1bb4de698f67c0c99ab527fb0fe22758 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/getpelican/pelican-plugins/blob/master/liquid_tags/__init__.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/getpelican/pelican-plugins/blob/touch/liquid_tags/__init__.py"
                 data-name="touch"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="button-group right">
    ...
    <button class="js-zeroclipboard minibutton zeroclipboard-button"
          data-clipboard-text="liquid_tags/__init__.py"
  ...
  <div class="commit commit-loader file-history-tease js-deferred-content" data-url="/getpelican/pelican-plugins/contributors/master/liquid_tags/__init__.py">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/getpelican/pelican-plugins/raw/master/liquid_tags/__init__.py" class="minibutton " id="raw-url">Raw</a>
            <a href="/getpelican/pelican-plugins/blame/master/liquid_tags/__init__.py" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/getpelican/pelican-plugins/commits/master/liquid_tags/__init__.py" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

          <a class="octicon-button tooltipped tooltipped-nw"
             href="github-windows://openRepo/https://github.com/getpelican/pelican-plugins?branch=master&amp;filepath=liquid_tags%2F__init__.py" aria-label="Open this file in GitHub for Windows">
              <span class="octicon octicon-device-desktop"></span>
          </a>

              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 aria-label="Clicking this button will fork this project so you can edit the file"
                 href="/getpelican/pelican-plugins/edit/master/liquid_tags/__init__.py"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/getpelican/pelican-plugins/delete/master/liquid_tags/__init__.py"
...
<table class="highlight tab-size-8 js-file-line-container">
      <tr>
        ...
        <td id="LC1" class="blob-line-code js-file-line"><span class="kn">from</span> <span class="nn">.liquid_tags</span> <span class="kn">import</span> <span class="o">*</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05848s from github-fe131-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
