...
<html lang="en" class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>pelican-plugins/vimeo.py at master · getpelican/pelican-plugins</title>
...
<meta content="w+QFvql4vuvLmwzFXz/0IN0OhPJ2mdiWGbVnhIGHywF+b7jyG1YZzfwV57Ova4MQWYgeGe7VKFmXXXpa5TRAQg==" name="csrf-token" />
...
<ul id="user-links">
  ...
  <li>
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="pZrpw8oSB1nwlcer0e51mY3ZzEZv8vEglRrbrXlca9Yvk0xh3q5dwb4kGT4Mde5POSBhbpEt/HENUTZ+hKQlkA==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="CkISxZFgZ+HYsBG0Ry7zVGD8AQ+EcqHZ9NBcwj0ZhDXfOzhTIozN39SHnQNi4io878MOwV581v4XeXZqzge3BQ==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="6547965" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="oV2UqOowTAn0gGLDB8PoO2tmHgBeqD5nulEwlINOObepeeLQf63RePr+tiYZ30Uu8vQzMZYxbv2gtop8FFXaDg==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="+MxL97AI6uHLpsXuu5lwEQhjM76GspyEsFaqMpWBLMuLndfyOt7TcvQEP6tTTLM9IrV5ZhhzyW9cbY6hUw3K6A==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/getpelican/pelican-plugins/blob/0fd006cec96a2aecc8c66119c67a9f704127e1c0/liquid_tags/vimeo.py" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:e21d7f7e298fc2b447752b0f1e76d30e -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/getpelican/pelican-plugins/blob/master/liquid_tags/vimeo.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/getpelican/pelican-plugins/blob/touch/liquid_tags/vimeo.py"
                 data-name="touch"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="button-group right">
    ...
    <button class="js-zeroclipboard minibutton zeroclipboard-button"
          data-clipboard-text="liquid_tags/vimeo.py"
...
<div class="file-box">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/getpelican/pelican-plugins/raw/master/liquid_tags/vimeo.py" class="minibutton " id="raw-url">Raw</a>
            <a href="/getpelican/pelican-plugins/blame/master/liquid_tags/vimeo.py" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/getpelican/pelican-plugins/commits/master/liquid_tags/vimeo.py" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

          <a class="octicon-button tooltipped tooltipped-nw"
             href="github-windows://openRepo/https://github.com/getpelican/pelican-plugins?branch=master&amp;filepath=liquid_tags%2Fvimeo.py" aria-label="Open this file in GitHub for Windows">
              <span class="octicon octicon-device-desktop"></span>
          </a>

              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 aria-label="Clicking this button will fork this project so you can edit the file"
                 href="/getpelican/pelican-plugins/edit/master/liquid_tags/vimeo.py"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/getpelican/pelican-plugins/delete/master/liquid_tags/vimeo.py"
  ...
  <div class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-line-code js-file-line"><span class="sd">Vimeo Tag</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC4" class="blob-line-code js-file-line"><span class="sd">This implements a Liquid-style vimeo tag for Pelican,</span></td>
      </tr>
      <tr>
        <td id="L5" class="blob-line-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-line-code js-file-line"><span class="sd">based on the youtube tag which is in turn based on</span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-line-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-line-code js-file-line"><span class="sd">the jekyll / octopress youtube tag [1]_</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC8" class="blob-line-code js-file-line"><span class="sd">Syntax</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-line-code js-file-line"><span class="sd">{% vimeo id [width height] %}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC12" class="blob-line-code js-file-line"><span class="sd">Example</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-line-code js-file-line"><span class="sd">{% vimeo 10739054 640 480 %}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-line-code js-file-line"><span class="sd">Output</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC18" class="blob-line-code js-file-line"><span class="sd">&lt;div style=&quot;width:640px; height:480px;&quot;&gt;&lt;iframe src=&quot;//player.vimeo.com/video/10739054?title=0&amp;amp;byline=0&amp;amp;portrait=0&quot; width=&quot;640&quot; height=&quot;480&quot; frameborder=&quot;0&quot; webkitallowfullscreen mozallowfullscreen allowfullscreen&gt;&lt;/iframe&gt;&lt;/div&gt;</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-line-code js-file-line"><span class="sd">[1] https://gist.github.com/jamieowen/2063748</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC22" class="blob-line-code js-file-line"><span class="kn">import</span> <span class="nn">re</span></td>
      </tr>
      <tr>
        <td id="L23" class="blob-line-num js-line-number" data-line-number="23"></td>
        <td id="LC23" class="blob-line-code js-file-line"><span class="kn">from</span> <span class="nn">.mdx_liquid_tags</span> <span class="kn">import</span> <span class="n">LiquidTags</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC25" class="blob-line-code js-file-line"><span class="n">SYNTAX</span> <span class="o">=</span> <span class="s">&quot;{% vimeo id [width height] %}&quot;</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-line-code js-file-line"><span class="n">VIMEO</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="s">r&#39;(\S+)(\s+(\d+)\s(\d+))?&#39;</span><span class="p">)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC30" class="blob-line-code js-file-line"><span class="nd">@LiquidTags.register</span><span class="p">(</span><span class="s">&#39;vimeo&#39;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L31" class="blob-line-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-line-code js-file-line"><span class="k">def</span> <span class="nf">vimeo</span><span class="p">(</span><span class="n">preprocessor</span><span class="p">,</span> <span class="n">tag</span><span class="p">,</span> <span class="n">markup</span><span class="p">):</span></td>
      </tr>
      <tr>
        <td id="L32" class="blob-line-num js-line-number" data-line-number="32"></td>
        <td id="LC32" class="blob-line-code js-file-line">    <span class="n">width</span> <span class="o">=</span> <span class="mi">640</span></td>
      </tr>
      <tr>
        <td id="L33" class="blob-line-num js-line-number" data-line-number="33"></td>
        <td id="LC33" class="blob-line-code js-file-line">    <span class="n">height</span> <span class="o">=</span> <span class="mi">390</span></td>
      </tr>
      <tr>
        <td id="L34" class="blob-line-num js-line-number" data-line-number="34"></td>
        <td id="LC34" class="blob-line-code js-file-line">    <span class="n">vimeo_id</span> <span class="o">=</span> <span class="bp">None</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC36" class="blob-line-code js-file-line">    <span class="n">match</span> <span class="o">=</span> <span class="n">VIMEO</span><span class="o">.</span><span class="n">search</span><span class="p">(</span><span class="n">markup</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L37" class="blob-line-num js-line-number" data-line-number="37"></td>
        <td id="LC37" class="blob-line-code js-file-line">    <span class="k">if</span> <span class="n">match</span><span class="p">:</span></td>
      </tr>
      <tr>
        <td id="L38" class="blob-line-num js-line-number" data-line-number="38"></td>
        <td id="LC38" class="blob-line-code js-file-line">        <span class="n">groups</span> <span class="o">=</span> <span class="n">match</span><span class="o">.</span><span class="n">groups</span><span class="p">()</span></td>
      </tr>
      <tr>
        <td id="L39" class="blob-line-num js-line-number" data-line-number="39"></td>
        <td id="LC39" class="blob-line-code js-file-line">        <span class="n">vimeo_id</span> <span class="o">=</span> <span class="n">groups</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L40" class="blob-line-num js-line-number" data-line-number="40"></td>
        <td id="LC40" class="blob-line-code js-file-line">        <span class="n">width</span> <span class="o">=</span> <span class="n">groups</span><span class="p">[</span><span class="mi">2</span><span class="p">]</span> <span class="ow">or</span> <span class="n">width</span></td>
      </tr>
      <tr>
        <td id="L41" class="blob-line-num js-line-number" data-line-number="41"></td>
        <td id="LC41" class="blob-line-code js-file-line">        <span class="n">height</span> <span class="o">=</span> <span class="n">groups</span><span class="p">[</span><span class="mi">3</span><span class="p">]</span> <span class="ow">or</span> <span class="n">height</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC43" class="blob-line-code js-file-line">    <span class="k">if</span> <span class="n">vimeo_id</span><span class="p">:</span></td>
      </tr>
      <tr>
        <td id="L44" class="blob-line-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-line-code js-file-line">        <span class="n">vimeo_out</span> <span class="o">=</span> <span class="s">&quot;&quot;&quot;</span></td>
      </tr>
      <tr>
        <td id="L45" class="blob-line-num js-line-number" data-line-number="45"></td>
        <td id="LC45" class="blob-line-code js-file-line"><span class="s">            &lt;div class=&quot;videobox&quot;&gt;</span></td>
      </tr>
      <tr>
        <td id="L46" class="blob-line-num js-line-number" data-line-number="46"></td>
        <td id="LC46" class="blob-line-code js-file-line"><span class="s">                &lt;iframe src=&quot;//player.vimeo.com/video/{vimeo_id}?title=0&amp;amp;byline=0&amp;amp;portrait=0&quot;</span></td>
      </tr>
      <tr>
        <td id="L47" class="blob-line-num js-line-number" data-line-number="47"></td>
        <td id="LC47" class="blob-line-code js-file-line"><span class="s">                        width=&quot;{width}&quot; height=&quot;{height}&quot; frameborder=&quot;0&quot;</span></td>
      </tr>
      <tr>
        <td id="L48" class="blob-line-num js-line-number" data-line-number="48"></td>
        <td id="LC48" class="blob-line-code js-file-line"><span class="s">                        webkitAllowFullScreen mozallowfullscreen allowFullScreen&gt;</span></td>
      </tr>
      <tr>
        <td id="L49" class="blob-line-num js-line-number" data-line-number="49"></td>
        <td id="LC49" class="blob-line-code js-file-line"><span class="s">                &lt;/iframe&gt;</span></td>
      </tr>
      <tr>
        <td id="L50" class="blob-line-num js-line-number" data-line-number="50"></td>
        <td id="LC50" class="blob-line-code js-file-line"><span class="s">            &lt;/div&gt;</span></td>
      </tr>
      <tr>
        <td id="L51" class="blob-line-num js-line-number" data-line-number="51"></td>
        <td id="LC51" class="blob-line-code js-file-line"><span class="s">        &quot;&quot;&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">width</span><span class="o">=</span><span class="n">width</span><span class="p">,</span> <span class="n">height</span><span class="o">=</span><span class="n">height</span><span class="p">,</span> <span class="n">vimeo_id</span><span class="o">=</span><span class="n">vimeo_id</span><span class="p">)</span><span class="o">.</span><span class="n">strip</span><span class="p">()</span></td>
      </tr>
      <tr>
        <td id="L52" class="blob-line-num js-line-number" data-line-number="52"></td>
        <td id="LC52" class="blob-line-code js-file-line">    <span class="k">else</span><span class="p">:</span></td>
      </tr>
      <tr>
        <td id="L53" class="blob-line-num js-line-number" data-line-number="53"></td>
        <td id="LC53" class="blob-line-code js-file-line">        <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;Error processing input, &quot;</span></td>
      </tr>
      <tr>
        <td id="L54" class="blob-line-num js-line-number" data-line-number="54"></td>
        <td id="LC54" class="blob-line-code js-file-line">                         <span class="s">&quot;expected syntax: {0}&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">SYNTAX</span><span class="p">))</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC56" class="blob-line-code js-file-line">    <span class="k">return</span> <span class="n">vimeo_out</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC60" class="blob-line-code js-file-line"><span class="c"># This import allows vimeo tag to be a Pelican plugin</span></td>
      </tr>
      <tr>
        <td id="L61" class="blob-line-num js-line-number" data-line-number="61"></td>
        <td id="LC61" class="blob-line-code js-file-line"><span class="kn">from</span> <span class="nn">liquid_tags</span> <span class="kn">import</span> <span class="n">register</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.07355s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
