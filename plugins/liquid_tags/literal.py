...
<html lang="en" class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>pelican-plugins/literal.py at master · getpelican/pelican-plugins</title>
...
<meta content="tYE/KBk8Pb32sKGyHwTpLsxBuqjSbMBDyK1U/nofvx0wVB31C3fqTO/woknf+oopPxCWS+Zox8WxZGfoiJfN4Q==" name="csrf-token" />
...
<ul id="user-links">
  ...
  <li>
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="dfGPW0HxG0qaXlDABovPojkZxtiWvvwd9e0TA2Quy+WWybJHq5vs/X22swSL1Ye5TMefYxtDagkg2qYjkbSH2g==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="QW03rXG/6geM4ZfJAIR1jhbDZP2hl8I+OT8gaU+LCoi7MlxdCw+/Pfjen0C8izsxRoWsRtM4AAOV7oBkc36tuQ==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="6547965" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="MmwfaW7owkCC2rh4oKtINvjO3lVYMqidcjqlMsBiCmGcN8G0qp0dEnGTgmopKVrLK0966jpxbaKAwd/WEhg4bA==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="NUBMXj49PWS4J2LM2bk4zjLYHi7VFXy1viydX1HIFthqeD1kwVu7yuw8PQodGDgr16arnGw5F1YVGIzBgD4a/Q==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/getpelican/pelican-plugins/blob/0fd006cec96a2aecc8c66119c67a9f704127e1c0/liquid_tags/literal.py" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:3c3ac386de8b66c6b9ef270cb36482d1 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/getpelican/pelican-plugins/blob/master/liquid_tags/literal.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/getpelican/pelican-plugins/blob/touch/liquid_tags/literal.py"
                 data-name="touch"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="button-group right">
    ...
    <button class="js-zeroclipboard minibutton zeroclipboard-button"
          data-clipboard-text="liquid_tags/literal.py"
  ...
  <div class="commit commit-loader file-history-tease js-deferred-content" data-url="/getpelican/pelican-plugins/contributors/master/liquid_tags/literal.py">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/getpelican/pelican-plugins/raw/master/liquid_tags/literal.py" class="minibutton " id="raw-url">Raw</a>
            <a href="/getpelican/pelican-plugins/blame/master/liquid_tags/literal.py" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/getpelican/pelican-plugins/commits/master/liquid_tags/literal.py" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

          <a class="octicon-button tooltipped tooltipped-nw"
             href="github-windows://openRepo/https://github.com/getpelican/pelican-plugins?branch=master&amp;filepath=liquid_tags%2Fliteral.py" aria-label="Open this file in GitHub for Windows">
              <span class="octicon octicon-device-desktop"></span>
          </a>

              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 aria-label="Clicking this button will fork this project so you can edit the file"
                 href="/getpelican/pelican-plugins/edit/master/liquid_tags/literal.py"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/getpelican/pelican-plugins/delete/master/liquid_tags/literal.py"
...
<table class="highlight tab-size-8 js-file-line-container">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-line-code js-file-line"><span class="sd">Literal Tag</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC4" class="blob-line-code js-file-line"><span class="sd">This implements a tag that allows explicitly showing commands which would</span></td>
      </tr>
      <tr>
        <td id="L5" class="blob-line-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-line-code js-file-line"><span class="sd">otherwise be interpreted as a liquid tag.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC7" class="blob-line-code js-file-line"><span class="sd">For example, the line</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-line-code js-file-line"><span class="sd">    {% literal video arg1 arg2 %}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC11" class="blob-line-code js-file-line"><span class="sd">would result in the following line:</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC13" class="blob-line-code js-file-line"><span class="sd">    {% video arg1 arg2 %}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC15" class="blob-line-code js-file-line"><span class="sd">This is useful when the resulting line would be interpreted as another</span></td>
      </tr>
      <tr>
        <td id="L16" class="blob-line-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-line-code js-file-line"><span class="sd">liquid-style tag.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC18" class="blob-line-code js-file-line"><span class="kn">from</span> <span class="nn">.mdx_liquid_tags</span> <span class="kn">import</span> <span class="n">LiquidTags</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-line-code js-file-line"><span class="nd">@LiquidTags.register</span><span class="p">(</span><span class="s">&#39;literal&#39;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L21" class="blob-line-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-line-code js-file-line"><span class="k">def</span> <span class="nf">literal</span><span class="p">(</span><span class="n">preprocessor</span><span class="p">,</span> <span class="n">tag</span><span class="p">,</span> <span class="n">markup</span><span class="p">):</span></td>
      </tr>
      <tr>
        <td id="L22" class="blob-line-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-line-code js-file-line">    <span class="k">return</span> <span class="s">&#39;{</span><span class="si">%%</span><span class="s"> </span><span class="si">%s</span><span class="s"> </span><span class="si">%%</span><span class="s">}&#39;</span> <span class="o">%</span> <span class="n">markup</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC25" class="blob-line-code js-file-line"><span class="c"># This import allows image tag to be a Pelican plugin</span></td>
      </tr>
      <tr>
        <td id="L26" class="blob-line-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-line-code js-file-line"><span class="kn">from</span> <span class="nn">liquid_tags</span> <span class="kn">import</span> <span class="n">register</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.06041s from github-fe137-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
